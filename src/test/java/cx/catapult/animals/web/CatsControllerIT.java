...
public class CatsControllerIT {
    ...
    public void updateShouldWork() throws Exception {
        ...
        Cat toUpdate = new Cat("UpdatedName", "UpdatedDescription");

        final ResponseEntity<Cat> response = template.exchange(base.toString() + "/" + created.getId(), HttpMethod.PUT, new HttpEntity<Cat>(toUpdate), Cat.class);
